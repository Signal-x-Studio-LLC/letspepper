...
export const powerRankings: PowerRanking[] = [
  ...
  },
  {
    ...
    scovilleRating: 4,
    trend: 'up',
    blurb: 'Silver at the Bell Pepper, bronze at the Grass Launch. The highest-placing non-champion trio in the series — always in the mix, always dangerous.',
    highlights: ['Silver + Bronze finishes', '125 total points each', 'Best non-champion finish'],
  },
  {
    rank: 3,
